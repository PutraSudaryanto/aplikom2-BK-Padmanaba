...
<table class="table table-striped table-bordered table-hover" width="100%" border="1">
  ...
  <tr>
    <th align="right" scope="row">Nama Kelas</th>
    <td><label for="nama_kelas"></label>
    <input type="text" name="nama_kelas" id="nama_kelas" value="<?php echo $data['nama_kelas'] ?>" /></td>
  </tr>
  <tr>
    <th align="right" scope="row">Tingkat Kelas</th>
    <td><label for="tingkat_kelas"></label>
    <input type="text" name="tingkat_kelas" id="tingkat_kelas" value="<?php echo $data['tingkat_kelas'] ?>" /></td>
  <tr>
